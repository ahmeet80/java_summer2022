...
public class C01 {
    ...
    public static void main(String[] args) {
       ...
       CLASSIN BASINDAN itibaren kod incelenmelidir.
        ...
        System.out.println("1 arttiktan sonra obj1'in rakam degeri :" + obj1.rakam); //
        System.out.println("1 arttiktan sonra obj1'in sayi degeri :" + sayi); //
        ...
        System.out.println("1 arttiktan sonra obje2'nin rakam degeri :" + obj1.rakam); //
        System.out.println("1 arttiktan sonra obje2'nin sayi degeri :" + sayi); //
