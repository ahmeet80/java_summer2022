...
public class C03_Exceptions_try_catchsiz {
    public static void main(String[] args) {
        ...
        */
        ...
        System.out.println("Istediginiz urun sira nosunu giriniz");
        int istenenSira =scan.nextInt();

        while(!(istenenSira>0 & istenenSira<6)){
            istenenSira =scan.nextInt();
            System.out.println("1 - 6 arasinda sira numarasi gir bu azaptan kurtul :):):) :");
        }
