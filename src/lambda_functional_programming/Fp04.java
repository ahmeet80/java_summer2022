...
public class Fp04 {
    public static void main(String[] args) {
        ...
        faktoriyelHesapla(4);
        System.out.println(verileIkiSayiArasindakiCiftSayilarinToplami(5, 10));
    ...
    public static int verileIkiSayiArasindakiCiftSayilarinToplami(int x, int y){
        int z=0;
        if(x>y){
            z = x;
            x = y;
            y = z;                                  // x ile y siralamasini uygunlastirmak icin swap yaptik
        }
