...
public class C01_Maps {
    ...
    public static void main(String[] args) {
        ...
        String[] eachArr;
        int sira=1;
        for (String each : tumValueColl) { // buradaki each bize her bir ogrenciye ait
                                           // ayni yapidaki isim, soyisim, brans bilgilerini
                                           // iceren String'ler getiriyor
            eachArr= each.split(", ");

            System.out.println(sira + "- " + eachArr[0] + " " + eachArr[1]);
            sira++;

        } /*    1- Ali Can    // sout ciktisi
                2- Enes Cem
                3- Taha Emre
                4- Derya Deniz
          */
